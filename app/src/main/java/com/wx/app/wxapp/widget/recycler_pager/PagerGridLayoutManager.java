...
package com.wx.app.wxapp.widget.recycler_pager;
...
import static com.wx.app.wxapp.widget.recycler_pager.PagerConfig.Loge;
import static com.wx.app.wxapp.widget.recycler_pager.PagerConfig.Logi;
...
public class PagerGridLayoutManager extends RecyclerView.LayoutManager
     ...
     */
    private void setPageCount(int pageCount) { //这里只有在view显示的时候才能调用，所有当view为隐藏时不能设置滑动到他的位置
        if (pageCount >= 0) {
