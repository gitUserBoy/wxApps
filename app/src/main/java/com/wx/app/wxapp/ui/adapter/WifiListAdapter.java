...
public class WifiListAdapter extends RecyclerView.Adapter<WifiListAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        if(position == 0  && (AppContants.WIFI_STATE_ON_CONNECTING.equals(bean.getState()) || AppContants.WIFI_STATE_CONNECT.equals(bean.getState()))){
            ...
            holder.tvItemWifiName.setTextColor(mContext.getResources().getColor(R.color.bottom_container_bg));
            holder.tvItemWifiStatus.setTextColor(mContext.getResources().getColor(R.color.bottom_container_bg));
        }
    ...
    public void setData(List<WifiBean> datas) {
